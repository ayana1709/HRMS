...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{
                url('public/backend/plugins/fontawesome-free/css/all.min.css')
            }}"
        />
        <!-- icheck bootstrap -->
        <link
        ...
        <link
            rel="stylesheet"
            href=" 
  {{ url('public/backend /dist/css/adminlte.min.css') }}"
        />
    </head>
    <body class="hold-transition login-page">
        ...
        <!-- jQuery -->
        <script src="{{
                url('public/backend/plugins/jquery/jquery.min.js')
            }}"></script>
        <!-- Bootstrap 4 -->
        <script src="{{
                url(
        ...
        <!-- AdminLTE App -->
        <script src="{{
                url('public/backend/dist/js/adminlte.min.js')
            }}"></script>
    </body>
</html>
